...
public class ConversationListActivity extends Activity {
    ...
    public void openConversation(int pos) {
        ...
        intent.putExtra(Constants.Conversation.RECIPIENT_ID, conversation.getUserId())
            .putExtra(Constants.Conversation.RECIPIENT_NAME, conversation.getUserName())
            .putExtra(Constants.Conversation.ITEM_ID, conversation.getItem().getId())
            .putExtra(Constants.Conversation.SHOW_COMPLETE_CONVERSATION, showCompleteConversation)
            .putExtra(Constants.ParseQuery.OBJECT_ID, conversation.getId());
